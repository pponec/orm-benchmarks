...
Performance tests executed against the H2 database lead to a slightly different ranking of the tested libraries.

The Spring Data JDBC library was excluded from this specific benchmark. Its design, which centers around the Aggregate Root pattern, requires a different approach to mapping deep-nested entity graphs and complex JOIN scenarios, making a direct one-to-one comparison difficult in this particular test setup.
